...
public class Debug extends JFrame implements ActionListener{
    ...
    int PosXT[] = new int[5];
    int PosYT[] = new int[5];
    int PosXTI[] = new int [5];
    int PosYTI[] = new int [5];
    int EscolhaJogador;
    ...
    public Debug(int n) throws IOException{  
                        ...
                        if(tX-1>0){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Cima") && m2[tX-1][tY].Tipo.equals("caminho")){
                                ...
                                m2[tX][tY] = new ElementosMapa("caminho");
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) andou para cima.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Cima";
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\tanqueCima.png"));
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) girou para cima.");
                            }
                        }
                        break;
                    case 1:
                        if(tX+1<12){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Baixo") && m2[tX+1][tY].Tipo.equals("caminho")){
                                ...
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\caminho.png"));
                                m2[tX][tY] = new ElementosMapa("caminho");
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) andou para baixo.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Baixo";
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\tanqueBaixo.png"));
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) girou para baixo.");
                            }
                        }
                        break;
                    case 2:
                        if(tY+1<12){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Direita") && m2[tX][tY+1].Tipo.equals("caminho")){
                                ...
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\caminho.png"));
                                m2[tX][tY] = new ElementosMapa("caminho");
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) andou para direita.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Direita";
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\tanqueDireita.png"));
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) girou para direita.");
                            }
                        }
                    ...
                    case 3:
                        if(tY-1>0){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Esquerda") && m2[tX][tY-1].Tipo.equals("caminho")){
                                ...
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\caminho.png"));
                                m2[tX][tY] = new ElementosMapa("caminho");
                                 System.out.println("O tanque " + cont + "(M-1 Abrams)  andou para esquerda.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Esquerda";
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\tanqueEsquerda.png"));
                                 System.out.println("O tanque " + cont + "(M-1 Abrams)  girou para esquerda.");
                            }
                        }
                        break;
                    case 4:
                        switch (((Tanque) (m2[tX][tY])).Direcao) {
                            case "Cima":                                
                                Atira(tX-1,tY);
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) atirou para cima.");
                                break OUTER;
                            case "Direita":                                
                                Atira(tX,tY+1);
                                 System.out.println("O tanque " + cont + "(M-1 Abrams) atirou para direita.");
                                break OUTER;
                            case "Baixo":
                                Atira(tX+1,tY);
                                System.out.println("O tanque " + cont + "(M-1 Abrams) atirou para baixo.");
                                break OUTER;
                            case "Esquerda":                                
                                Atira(tX,tY-1);
                                System.out.println("O tanque " + cont + "(M-1 Abrams) atirou para esquerda.");
                                break OUTER;
                            default:
                                break;
                        } 
                ...
                switch (variavel2) {
                    case 0:
                        if(tX-1>0){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Cima") && m2[tX-1][tY].Tipo.equals("caminho")){
                                ...
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\caminho.png"));
                                m2[tX][tY] = new ElementosMapa("caminho");
                                System.out.println("O tanque "+ cont + "(Centurion) andou para cima.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Cima";
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\inimigoCima.png"));
                                System.out.println("O tanque "+ cont + "(Centurion) girou para cima.");
                            }
                        }
                        break;
                    case 1:
                        if(tX+1<12){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Baixo") && m2[tX+1][tY].Tipo.equals("caminho")){
                                ...
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\caminho.png"));
                                m2[tX][tY] = new ElementosMapa("caminho");
                                System.out.println("O tanque "+ cont + "(Centurion) andou para baixo.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Baixo";
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\inimigoBaixo.png"));
                                System.out.println("O tanque "+ cont + "(Centurion) girou para baixo.");
                            }
                        }
                        break;
                    case 2:
                        if(tY+1<12){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Direita") && m2[tX][tY+1].Tipo.equals("caminho")){
                                ...
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\caminho.png"));
                                m2[tX][tY] = new ElementosMapa("caminho");
                                System.out.println("O tanque "+ cont + "(Centurion) andou para direita.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Direita";
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\inimigoDireita.png"));
                                System.out.println("O tanque "+ cont + "(Centurion) girou para direita.");
                    ...
                    case 3:
                        if(tY-1>0){
                            if(((Tanque) (m2[tX][tY])).Direcao.equals("Esquerda") && m2[tX][tY-1].Tipo.equals("caminho")){
                                ...
                                BMapa[tX][tY].setIcon(new ImageIcon("imagem\\caminho.png"));
                                m2[tX][tY] = new ElementosMapa("caminho");
                                System.out.println("O tanque "+ cont + "(Centurion) andou para esquerda.");
                            }
                            else{
                                ((Tanque)(m2[tX][tY])).Direcao="Esquerda";
                    ...
                    case 4:
                        switch (((Tanque) (m2[tX][tY])).Direcao) {
                            case "Cima":                                
                                Atira(tX-1,tY);
                                System.out.println("O tanque "+ cont + "(Centurion) atirou para cima.");
                                break OUTER;
                            case "Direita":                                
                                Atira(tX,tY+1);
                                 System.out.println("O tanque "+ cont + "(Centurion) atirou para direita.");
                                break OUTER;
                            case "Baixo":
                                Atira(tX+1,tY);
                                System.out.println("O tanque "+ cont + "(Centurion) atirou para baixo.");
                                break OUTER;
                            case "Esquerda":
                                Atira(tX,tY-1);
                                 System.out.println("O tanque "+ cont + "(Centurion) atirou para esquerda.");
                                break OUTER;
                            default:
                                break;
                        } 
